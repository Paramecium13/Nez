...
namespace Nez
{
	public static class SpriteBatchExt
	{
		...
		public static void DrawLine(this SpriteBatch spriteBatch, System.Numerics.Vector2 start, System.Numerics.Vector2 end, Color color)
		{
			DrawLineAngle(spriteBatch, start, Mathf.AngleBetweenVectors(start, end), System.Numerics.Vector2.Distance(start, end),
				color);
		}
		...
		{
			DrawLine(spriteBatch, new System.Numerics.Vector2(x1, y1), new System.Numerics.Vector2(x2, y2), color);
		}
		...
		public static void DrawPoints(this SpriteBatch spriteBatch, List<System.Numerics.Vector2> points, Color color,
		                              float thickness = 1)
		{
			if (points.Count < 2)
				return;
		...
		/// <param name="color">The color to use</param>
		/// <param name="thickness">The thickness of the lines</param>
		public static void DrawPoints(this SpriteBatch spriteBatch, System.Numerics.Vector2[] points, Color color, float thickness = 1)
		{
			if (points.Length < 2)
				return;
		...
		public static void DrawPoints(this SpriteBatch spriteBatch, System.Numerics.Vector2 position, System.Numerics.Vector2[] points, Color color,
		...
		public static void DrawPolygon(this SpriteBatch spriteBatch, System.Numerics.Vector2 position, System.Numerics.Vector2[] points, Color color,
		                               bool closePoly = true, float thickness = 1)
		{
			if (points.Length < 2)
				return;
		...
		{
			DrawLineAngle(spriteBatch, new System.Numerics.Vector2(startX, startY), angle, length, color);
		}
		...
		public static void DrawCircle(this SpriteBatch spriteBatch, float x, float y, float radius, Color color,
		                              int resolution)
		{
			DrawCircle(spriteBatch, new System.Numerics.Vector2(x, y), radius, color, resolution);
		}
		...
		public static void DrawRect(this SpriteBatch spriteBatch, System.Numerics.Vector2 position, float width, float height,
		                            Color color)
		{
		...
		public static void DrawHollowRect(this SpriteBatch spriteBatch, System.Numerics.Vector2 position, float width, float height,
		                                  Color color)
		{
		...
		{
			DrawPixel(spriteBatch, new System.Numerics.Vector2(x, y), color);
		}
