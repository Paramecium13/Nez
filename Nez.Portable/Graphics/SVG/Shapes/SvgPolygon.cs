...
namespace Nez.Svg
{
	public class SvgPolygon : SvgElement
	{
		...
		void ParsePoints(string str)
		{
			...
			Points = new System.Numerics.Vector2[pairs.Length];

			for (var i = 0; i < pairs.Length; i++)
			{
				var parts = pairs[i].Split(new char[] {','}, System.StringSplitOptions.RemoveEmptyEntries);
				Points[i] = new System.Numerics.Vector2(float.Parse(parts[0], format), float.Parse(parts[1], format));
			}
		}
		...
		public System.Numerics.Vector2[] GetRelativePoints()
		{
			var pts = new System.Numerics.Vector2[Points.Length];

			var center = new System.Numerics.Vector2(CenterX, CenterY);
