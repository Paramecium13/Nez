...
namespace Nez.Tiled
{
	...
	public static class TiledRendering
	{
		...
		public static void RenderMap(TmxMap map, Batcher batcher, System.Numerics.Vector2 position, System.Numerics.Vector2 scale, float layerDepth, RectangleF cameraClipBounds)
		{
