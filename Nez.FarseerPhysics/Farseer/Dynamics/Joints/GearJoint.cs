...
namespace FarseerPhysics.Dynamics.Joints
{
	...
	public class GearJoint : Joint
	{
		...
		// Solver shared
		System.Numerics.Vector2 _localAnchorA;
		System.Numerics.Vector2 _localAnchorB;
		System.Numerics.Vector2 _localAnchorC;
		System.Numerics.Vector2 _localAnchorD;

		System.Numerics.Vector2 _localAxisC;
		System.Numerics.Vector2 _localAxisD;
		...
		System.Numerics.Vector2 _lcA, _lcB, _lcC, _lcD;
		float _mA, _mB, _mC, _mD;
		float _iA, _iB, _iC, _iD;
		System.Numerics.Vector2 _JvAC, _JvBD;
		...
		public GearJoint(Body bodyA, Body bodyB, Joint jointA, Joint jointB, float ratio = 1f)
		{
			...
			if (_typeA == JointType.Revolute)
			{
				...
				_localAxisC = System.Numerics.Vector2.Zero;
			...
			else
			{
				...
				System.Numerics.Vector2 pC = _localAnchorC;
				System.Numerics.Vector2 pA = MathUtils.MulT(xfC.Q, MathUtils.Mul(xfA.Q, _localAnchorA) + (xfA.P - xfC.P));
				coordinateA = System.Numerics.Vector2.Dot(pA - pC, _localAxisC);
			}
			...
			if (_typeB == JointType.Revolute)
			{
				...
				_localAxisD = System.Numerics.Vector2.Zero;
			...
			else
			{
				...
				System.Numerics.Vector2 pD = _localAnchorD;
				System.Numerics.Vector2 pB = MathUtils.MulT(xfD.Q, MathUtils.Mul(xfB.Q, _localAnchorB) + (xfB.P - xfD.P));
				coordinateB = System.Numerics.Vector2.Dot(pB - pD, _localAxisD);
			}
		...
		{
			System.Numerics.Vector2 P = _impulse * _JvAC;
			return invDt * P;
		}
		...
		internal override void InitVelocityConstraints(ref SolverData data)
		{
			...
			System.Numerics.Vector2 vC = data.Velocities[_indexC].V;
			float wC = data.Velocities[_indexC].W;

			float aD = data.Positions[_indexD].A;
			System.Numerics.Vector2 vD = data.Velocities[_indexD].V;
			...
			if (_typeA == JointType.Revolute)
			{
				_JvAC = System.Numerics.Vector2.Zero;
				_JwA = 1.0f;
				_JwC = 1.0f;
				_mass += _iA + _iC;
			}
			...
			{
				System.Numerics.Vector2 u = MathUtils.Mul(qC, _localAxisC);
				System.Numerics.Vector2 rC = MathUtils.Mul(qC, _localAnchorC - _lcC);
				System.Numerics.Vector2 rA = MathUtils.Mul(qA, _localAnchorA - _lcA);
				_JvAC = u;
			...
			if (_typeB == JointType.Revolute)
			{
				_JvBD = System.Numerics.Vector2.Zero;
				_JwB = _ratio;
				_JwD = _ratio;
			...
			{
				System.Numerics.Vector2 u = MathUtils.Mul(qD, _localAxisD);
				System.Numerics.Vector2 rD = MathUtils.Mul(qD, _localAnchorD - _lcD);
				System.Numerics.Vector2 rB = MathUtils.Mul(qB, _localAnchorB - _lcB);
				_JvBD = _ratio * u;
		...
		internal override void SolveVelocityConstraints(ref SolverData data)
		{
			...
			float Cdot = System.Numerics.Vector2.Dot(_JvAC, vA - vC) + System.Numerics.Vector2.Dot(_JvBD, vB - vD);
		...
		internal override bool SolvePositionConstraints(ref SolverData data)
		{
			...
			float aB = data.Positions[_indexB].A;
			System.Numerics.Vector2 cC = data.Positions[_indexC].C;
			float aC = data.Positions[_indexC].A;
			System.Numerics.Vector2 cD = data.Positions[_indexD].C;
			float aD = data.Positions[_indexD].A;
			...
			System.Numerics.Vector2 JvAC, JvBD;
			float JwA, JwB, JwC, JwD;
			float mass = 0.0f;

			if (_typeA == JointType.Revolute)
			{
				JvAC = System.Numerics.Vector2.Zero;
				JwA = 1.0f;
				JwC = 1.0f;
				mass += _iA + _iC;
			...
			else
			{
				...
				System.Numerics.Vector2 pC = _localAnchorC - _lcC;
				System.Numerics.Vector2 pA = MathUtils.MulT(qC, rA + (cA - cC));
				coordinateA = System.Numerics.Vector2.Dot(pA - pC, _localAxisC);
			}

			if (_typeB == JointType.Revolute)
			{
				JvBD = System.Numerics.Vector2.Zero;
				JwB = _ratio;
				JwD = _ratio;
			...
			else
			{
				...
				System.Numerics.Vector2 pD = _localAnchorD - _lcD;
				System.Numerics.Vector2 pB = MathUtils.MulT(qD, rB + (cB - cD));
				coordinateB = System.Numerics.Vector2.Dot(pB - pD, _localAxisD);
			}
