...
namespace FarseerPhysics.Factories
{
	public static class LinkFactory
	{
		...
		public static List<Body> CreateChain(World world, System.Numerics.Vector2 start, System.Numerics.Vector2 end, float linkWidth, float linkHeight,
		                                     ...
		                                     bool fixStart = false, bool fixEnd = false)
		{
			...
			if (fixStart)
			{
				...
				JointFactory.CreateRevoluteJoint(world, chainLinks[0], axle, new System.Numerics.Vector2(0, -(linkHeight / 2)),
			...
			if (fixEnd)
			{
				...
				JointFactory.CreateRevoluteJoint(world, chainLinks[lastIndex], axle, new System.Numerics.Vector2(0, -(linkHeight / 2)),
					System.Numerics.Vector2.Zero);
			}

			// Attach all the chainlinks together with a revolute joint
			PathManager.AttachBodiesWithRevoluteJoint(world, chainLinks, new System.Numerics.Vector2(0, -linkHeight),
				new System.Numerics.Vector2(0, linkHeight), false, false);

			if (attachRopeJoint)
				JointFactory.CreateRopeJoint(world, chainLinks[0], chainLinks[chainLinks.Count - 1], System.Numerics.Vector2.Zero,
					System.Numerics.Vector2.Zero);
